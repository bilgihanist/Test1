const Helloworld = artifacts.require("Helloworld"); // sözleşmenin adından geliyor
...
module.exports = function(deployer) {
    deployer.deploy(Helloworld, "Hello world constructor").then( async () => {
        ...
        return deployer.deploy(HelloworldPermanent, message) // return koymazsak çoğul olur 
    });
};